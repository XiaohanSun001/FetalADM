...
filename1='../datastandard1/Standardtraindata.csv'
filename2='../datastandard1/Standardtest.csv'
filename3='../smotedata2/traindata_356_27.csv'


data_extract(filename1,'primary216_13.csv')
data_extract(filename2,'test54_13.csv')
data_extract(filename3,'modeldata356_13.csv')
